...
**Desarrollo**
- Apps web con **Angular** (componentes, módulos, routing, consumo de APIs).
- Herramientas y automatizaciones en **Python**.
- Bases sólidas en algoritmos, POO y bases de datos (formación universitaria).

**Entrenamiento de IA**
- Evaluación y comparación de respuestas de LLMs según rúbricas de calidad.
- Prompt engineering e iteración de instrucciones.
- Criterios de seguridad, exactitud y formato para fine-tuning.
